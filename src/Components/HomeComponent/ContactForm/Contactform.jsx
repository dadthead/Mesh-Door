...
export default function UniqueBusinessContactForm() {
  ...
  return (
    <div className="w-full flex flex-col md:flex-row bg-gradient-to-r from-white to-[#94fbf6] px-4 sm:px-6 md:px-16 py-8 md:py-16 lg:py-20">
      {/* Left Form Side */}
      <div className="md:w-1/2 bg-opacity-90 p-6 sm:p-8 md:p-10 flex flex-col justify-center">
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#44b4af] mb-6">
          Get in Touch
        </h2>
        <p className="mb-6 sm:mb-8 text-gray-700 font-medium text-sm sm:text-base md:text-lg">
          Have questions or want to discuss any work ? Send us a message!
        </p>
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-6">
          ...
          <div className="relative">
            <input
              ...
              onChange={handleChange}
              id="name"
              className={`peer block w-full appearance-none border-b-2 bg-transparent py-3 sm:py-4 md:py-6 text-sm sm:text-base md:text-lg text-gray-900 placeholder-transparent focus:outline-none focus:border-[#44b4af] ${
                errors.name ? "border-red-500" : "border-gray-300"
              }`}
              placeholder="Full Name"
            />
          ...
          <div className="relative">
            <textarea
              ...
              id="message"
              rows="4"
              className={`peer block w-full resize-none appearance-none border-b-2 bg-transparent py-3 sm:py-4 md:py-6 text-sm sm:text-base md:text-lg text-gray-900 placeholder-transparent focus:outline-none focus:border-[#44b4af] ${
                errors.message ? "border-red-500" : "border-gray-300"
              }`}
              placeholder="Your Message"
            ></textarea>
          ...
          <button
            type="submit"
            className="w-full bg-[#44b4af] text-white font-bold py-2 sm:py-3 md:py-4 text-sm sm:text-base md:text-lg rounded-lg shadow-md hover:shadow-lg hover:bg-[#369b97] transition duration-300"
          >
            Send Message
          </button>
        </form>
      ...
      {/* Right Info Side */}
      <div className="md:w-1/2 flex flex-col justify-center mt-8 md:mt-0 px-2 sm:px-6 md:px-10 lg:px-18">
        <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#44b4af] font-bold mb-4 sm:mb-6 underline underline-offset-3">
          Our Office
        </h3>
        <p className="mb-4 text-base sm:text-lg md:text-xl leading-relaxed px-1 sm:px-2">
          Plot No.200,<br />
          Gokul Plots,<br />
          Near Hanuman Temple, <br/>
          Hafeespet, Hyderabad - 500085.
        </p>
        <p className="mb-4 text-sm sm:text-base md:text-lg leading-relaxed px-1 sm:px-2">
          Phone: +91 70754 16949<br />
          Email: contact@business.com
        </p>
        <p className="text-sm sm:text-base md:text-lg leading-relaxed px-1 sm:px-2 italic">
          We are here to help you 24/7. Reach out to us anytime!
        </p>
      </div>
    </div>
